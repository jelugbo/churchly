...
class MediaTableMap extends TableMap
{
     ...
     */
    const COL_VALUE = 'media.value';

    /**
     * the column name for the parish_id field
     */
    const COL_PARISH_ID = 'media.parish_id';
     ...
     */
    const COL_CATEGORY = 'media.category';
    ...
    /**
     * the column name for the publish_on field
     */
    const COL_PUBLISH_ON = 'media.publish_on';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Value', 'ParishId', 'Title', 'Category', 'Type', 'Url', 'PublishOn', 'CreatedAt', ),
        self::TYPE_CAMELNAME     => array('value', 'parishId', 'title', 'category', 'type', 'url', 'publishOn', 'createdAt', ),
        self::TYPE_COLNAME       => array(MediaTableMap::COL_VALUE, MediaTableMap::COL_PARISH_ID, MediaTableMap::COL_TITLE, MediaTableMap::COL_CATEGORY, MediaTableMap::COL_TYPE, MediaTableMap::COL_URL, MediaTableMap::COL_PUBLISH_ON, MediaTableMap::COL_CREATED_AT, ),
        self::TYPE_FIELDNAME     => array('value', 'parish_id', 'title', 'category', 'type', 'url', 'publish_on', 'created_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Value' => 0, 'ParishId' => 1, 'Title' => 2, 'Category' => 3, 'Type' => 4, 'Url' => 5, 'PublishOn' => 6, 'CreatedAt' => 7, ),
        self::TYPE_CAMELNAME     => array('value' => 0, 'parishId' => 1, 'title' => 2, 'category' => 3, 'type' => 4, 'url' => 5, 'publishOn' => 6, 'createdAt' => 7, ),
        self::TYPE_COLNAME       => array(MediaTableMap::COL_VALUE => 0, MediaTableMap::COL_PARISH_ID => 1, MediaTableMap::COL_TITLE => 2, MediaTableMap::COL_CATEGORY => 3, MediaTableMap::COL_TYPE => 4, MediaTableMap::COL_URL => 5, MediaTableMap::COL_PUBLISH_ON => 6, MediaTableMap::COL_CREATED_AT => 7, ),
        self::TYPE_FIELDNAME     => array('value' => 0, 'parish_id' => 1, 'title' => 2, 'category' => 3, 'type' => 4, 'url' => 5, 'publish_on' => 6, 'created_at' => 7, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addForeignKey('category', 'Category', 'INTEGER', 'media_categories', 'value', true, null, null);
        $this->addForeignKey('type', 'Type', 'INTEGER', 'media_type', 'value', true, null, null);
        $this->addColumn('url', 'Url', 'VARCHAR', false, 200, null);
        $this->addColumn('publish_on', 'PublishOn', 'TIMESTAMP', true, null, 'CURRENT_TIMESTAMP');
  ...
  array (
    ...
    1 => ':value',
        ...
        $this->addRelation('MediaCategories', '\\MediaCategories', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':category',
    1 => ':value',
  ...
  array (
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(MediaTableMap::COL_VALUE);
            $criteria->addSelectColumn(MediaTableMap::COL_PARISH_ID);
            $criteria->addSelectColumn(MediaTableMap::COL_TITLE);
            $criteria->addSelectColumn(MediaTableMap::COL_CATEGORY);
            $criteria->addSelectColumn(MediaTableMap::COL_TYPE);
            $criteria->addSelectColumn(MediaTableMap::COL_URL);
            $criteria->addSelectColumn(MediaTableMap::COL_PUBLISH_ON);
            ...
            $criteria->addSelectColumn($alias . '.publish_on');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(MediaTableMap::COL_VALUE, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(MediaTableMap::COL_VALUE) && $criteria->keyContainsValue(MediaTableMap::COL_VALUE) ) {
