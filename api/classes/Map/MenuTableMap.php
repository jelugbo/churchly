...
class MenuTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Value', 'Name', 'Link', 'Parent', 'CreatedAt', ),
        self::TYPE_CAMELNAME     => array('value', 'name', 'link', 'parent', 'createdAt', ),
        self::TYPE_COLNAME       => array(MenuTableMap::COL_VALUE, MenuTableMap::COL_NAME, MenuTableMap::COL_LINK, MenuTableMap::COL_PARENT, MenuTableMap::COL_CREATED_AT, ),
        self::TYPE_FIELDNAME     => array('value', 'name', 'link', 'parent', 'created_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Value' => 0, 'Name' => 1, 'Link' => 2, 'Parent' => 3, 'CreatedAt' => 4, ),
        self::TYPE_CAMELNAME     => array('value' => 0, 'name' => 1, 'link' => 2, 'parent' => 3, 'createdAt' => 4, ),
        self::TYPE_COLNAME       => array(MenuTableMap::COL_VALUE => 0, MenuTableMap::COL_NAME => 1, MenuTableMap::COL_LINK => 2, MenuTableMap::COL_PARENT => 3, MenuTableMap::COL_CREATED_AT => 4, ),
        self::TYPE_FIELDNAME     => array('value' => 0, 'name' => 1, 'link' => 2, 'parent' => 3, 'created_at' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
  ...
  array (
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(MenuTableMap::COL_VALUE);
            $criteria->addSelectColumn(MenuTableMap::COL_NAME);
            $criteria->addSelectColumn(MenuTableMap::COL_LINK);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(MenuTableMap::COL_VALUE, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(MenuTableMap::COL_VALUE) && $criteria->keyContainsValue(MenuTableMap::COL_VALUE) ) {
