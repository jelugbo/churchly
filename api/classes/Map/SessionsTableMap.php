...
class SessionsTableMap extends TableMap
{
     ...
     */
    const COL_ACCESS = 'sessions.access';

    /**
     * the column name for the data field
     */
    const COL_DATA = 'sessions.data';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Access', 'Data', ),
        self::TYPE_CAMELNAME     => array('id', 'access', 'data', ),
        self::TYPE_COLNAME       => array(SessionsTableMap::COL_ID, SessionsTableMap::COL_ACCESS, SessionsTableMap::COL_DATA, ),
        self::TYPE_FIELDNAME     => array('id', 'access', 'data', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Access' => 1, 'Data' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'access' => 1, 'data' => 2, ),
        self::TYPE_COLNAME       => array(SessionsTableMap::COL_ID => 0, SessionsTableMap::COL_ACCESS => 1, SessionsTableMap::COL_DATA => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'access' => 1, 'data' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('access', 'Access', 'INTEGER', false, 10, null);
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(SessionsTableMap::COL_ACCESS);
