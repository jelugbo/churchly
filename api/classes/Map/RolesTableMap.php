...
class RolesTableMap extends TableMap
{
     ...
     */
    const COL_CREATED_AT = 'roles.created_at';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(RolesTableMap::COL_VALUE, RolesTableMap::COL_NAME, RolesTableMap::COL_CREATED_AT, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(RolesTableMap::COL_VALUE => 0, RolesTableMap::COL_NAME => 1, RolesTableMap::COL_CREATED_AT => 2, ),
    ...
    {
        $this->addRelation('MenuRoles', '\\MenuRoles', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':role_id',
    1 => ':value',
  ),
), null, null, 'MenuRoless', false);
  ...
  array (
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(RolesTableMap::COL_VALUE);
            $criteria->addSelectColumn(RolesTableMap::COL_NAME);
            $criteria->addSelectColumn(RolesTableMap::COL_CREATED_AT);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(RolesTableMap::COL_VALUE, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(RolesTableMap::COL_VALUE) && $criteria->keyContainsValue(RolesTableMap::COL_VALUE) ) {
            throw new PropelException('Cannot insert a value for auto-increment primary key ('.RolesTableMap::COL_VALUE.')');
        }
