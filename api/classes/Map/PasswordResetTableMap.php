...
class PasswordResetTableMap extends TableMap
{
     ...
     */
    const COL_VALUE = 'password_reset.value';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Value', 'Username', 'Token', 'Attempts', 'Timestamp', ),
        self::TYPE_CAMELNAME     => array('value', 'username', 'token', 'attempts', 'timestamp', ),
        self::TYPE_COLNAME       => array(PasswordResetTableMap::COL_VALUE, PasswordResetTableMap::COL_USERNAME, PasswordResetTableMap::COL_TOKEN, PasswordResetTableMap::COL_ATTEMPTS, PasswordResetTableMap::COL_TIMESTAMP, ),
        self::TYPE_FIELDNAME     => array('value', 'username', 'token', 'attempts', 'timestamp', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Value' => 0, 'Username' => 1, 'Token' => 2, 'Attempts' => 3, 'Timestamp' => 4, ),
        self::TYPE_CAMELNAME     => array('value' => 0, 'username' => 1, 'token' => 2, 'attempts' => 3, 'timestamp' => 4, ),
        self::TYPE_COLNAME       => array(PasswordResetTableMap::COL_VALUE => 0, PasswordResetTableMap::COL_USERNAME => 1, PasswordResetTableMap::COL_TOKEN => 2, PasswordResetTableMap::COL_ATTEMPTS => 3, PasswordResetTableMap::COL_TIMESTAMP => 4, ),
        self::TYPE_FIELDNAME     => array('value' => 0, 'username' => 1, 'token' => 2, 'attempts' => 3, 'timestamp' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(PasswordResetTableMap::COL_VALUE);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(PasswordResetTableMap::COL_VALUE, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(PasswordResetTableMap::COL_VALUE) && $criteria->keyContainsValue(PasswordResetTableMap::COL_VALUE) ) {
