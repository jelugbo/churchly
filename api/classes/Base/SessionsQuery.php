 ...
 * @method     ChildSessions requireOneByAccess(int $access) Return the first ChildSessions filtered by the access column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
