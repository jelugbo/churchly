...
/**
 * Base class that represents a row from the 'give_currency' table.
 *
 * 
 *
 * @package    propel.generator..Base
 */
abstract class GiveCurrency implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\GiveCurrencyTableMap';
    ...
    /**
     * Initializes internal state of Base\GiveCurrency object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>GiveCurrency</code> instance.  If
     * <code>obj</code> is an instance of <code>GiveCurrency</code>, delegates to
     * <code>equals(GiveCurrency)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|GiveCurrency The current object, for fluid interface
     */
     ...
     * @return $this|\GiveCurrency The current object (for fluent API support)
     */
    public function setValue($v)
    {
        ...
        if ($this->value !== $v) {
            $this->value = $v;
            $this->modifiedColumns[GiveCurrencyTableMap::COL_VALUE] = true;
        }
    ...
    public function setCode($v)
    {
        ...
        if ($this->code !== $v) {
            $this->code = $v;
            $this->modifiedColumns[GiveCurrencyTableMap::COL_CODE] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[GiveCurrencyTableMap::COL_NAME] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[GiveCurrencyTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : GiveCurrencyTableMap::translateFieldName('Value', TableMap::TYPE_PHPNAME, $indexType)];
            $this->value = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : GiveCurrencyTableMap::translateFieldName('Code', TableMap::TYPE_PHPNAME, $indexType)];
            $this->code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : GiveCurrencyTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : GiveCurrencyTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = GiveCurrencyTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\GiveCurrency'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildGiveCurrencyQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see GiveCurrency::setDeleted()
     * @see GiveCurrency::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildGiveCurrencyQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                GiveCurrencyTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[GiveCurrencyTableMap::COL_VALUE] = true;
        if (null !== $this->value) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . GiveCurrencyTableMap::COL_VALUE . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(GiveCurrencyTableMap::COL_VALUE)) {
            $modifiedColumns[':p' . $index++]  = 'value';
        }
        if ($this->isColumnModified(GiveCurrencyTableMap::COL_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'code';
        }
        if ($this->isColumnModified(GiveCurrencyTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(GiveCurrencyTableMap::COL_CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'created_at';
        }

        $sql = sprintf(
            'INSERT INTO give_currency (%s) VALUES (%s)',
    ...
    {
        $pos = GiveCurrencyTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['GiveCurrency'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['GiveCurrency'][$this->hashCode()] = true;
        $keys = GiveCurrencyTableMap::getFieldNames($keyType);
        $result = array(
    ...
    {
        $criteria = new Criteria(GiveCurrencyTableMap::DATABASE_NAME);

        if ($this->isColumnModified(GiveCurrencyTableMap::COL_VALUE)) {
            $criteria->add(GiveCurrencyTableMap::COL_VALUE, $this->value);
        }
        if ($this->isColumnModified(GiveCurrencyTableMap::COL_CODE)) {
            $criteria->add(GiveCurrencyTableMap::COL_CODE, $this->code);
        }
        if ($this->isColumnModified(GiveCurrencyTableMap::COL_NAME)) {
            $criteria->add(GiveCurrencyTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(GiveCurrencyTableMap::COL_CREATED_AT)) {
            $criteria->add(GiveCurrencyTableMap::COL_CREATED_AT, $this->created_at);
        }
    ...
    {
        $criteria = ChildGiveCurrencyQuery::create();
        $criteria->add(GiveCurrencyTableMap::COL_VALUE, $this->value);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \GiveCurrency (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \GiveCurrency Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildGiveCurrency is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildGiveCurrency The current object (for fluent API support)
     */
    public function setGiveParishCurrencies(Collection $giveParishCurrencies, ConnectionInterface $con = null)
    {
        ...
        foreach ($giveParishCurrenciesToDelete as $giveParishCurrencyRemoved) {
            $giveParishCurrencyRemoved->setGiveCurrency(null);
        }
    ...
    protected function doAddGiveParishCurrency(ChildGiveParishCurrency $giveParishCurrency)
    {
        ...
        $giveParishCurrency->setGiveCurrency($this);
    }
    ...
    public function removeGiveParishCurrency(ChildGiveParishCurrency $giveParishCurrency)
    {
        if ($this->getGiveParishCurrencies()->contains($giveParishCurrency)) {
            ...
            $giveParishCurrency->setGiveCurrency(null);
        }
     ...
     * Otherwise if this GiveCurrency is new, it will return
     * an empty collection; or if this GiveCurrency has previously
     * been saved, it will retrieve related GiveParishCurrencies from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in GiveCurrency.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildGiveParishCurrency[] List of ChildGiveParishCurrency objects
     */
    public function getGiveParishCurrenciesJoinParish(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildGiveParishCurrencyQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(GiveCurrencyTableMap::DEFAULT_STRING_FORMAT);
    }
