...
/**
 * Base class that represents a row from the 'give_parish_methods' table.
 *
 * 
 *
 * @package    propel.generator..Base
 */
abstract class GiveParishMethods implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\GiveParishMethodsTableMap';
    ...
    /**
     * @var        ChildGiveMethods
     */
    protected $aGiveMethods;
    ...
    /**
     * Initializes internal state of Base\GiveParishMethods object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>GiveParishMethods</code> instance.  If
     * <code>obj</code> is an instance of <code>GiveParishMethods</code>, delegates to
     * <code>equals(GiveParishMethods)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|GiveParishMethods The current object, for fluid interface
     */
     ...
     * @return $this|\GiveParishMethods The current object (for fluent API support)
     */
    public function setValue($v)
    {
        ...
        if ($this->value !== $v) {
            $this->value = $v;
            $this->modifiedColumns[GiveParishMethodsTableMap::COL_VALUE] = true;
        }
    ...
    public function setParishId($v)
    {
        ...
        if ($this->parish_id !== $v) {
            $this->parish_id = $v;
            $this->modifiedColumns[GiveParishMethodsTableMap::COL_PARISH_ID] = true;
        }
    ...
    public function setMethodId($v)
    {
        ...
        if ($this->method_id !== $v) {
            $this->method_id = $v;
            $this->modifiedColumns[GiveParishMethodsTableMap::COL_METHOD_ID] = true;
        }

        if ($this->aGiveMethods !== null && $this->aGiveMethods->getValue() !== $v) {
            $this->aGiveMethods = null;
        }
    ...
    public function setSettings($v)
    {
        ...
        if ($this->settings !== $v) {
            $this->settings = $v;
            $this->modifiedColumns[GiveParishMethodsTableMap::COL_SETTINGS] = true;
        }
    ...
    public function setEnabled($v)
    {
        ...
        if ($this->enabled !== $v) {
            $this->enabled = $v;
            $this->modifiedColumns[GiveParishMethodsTableMap::COL_ENABLED] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[GiveParishMethodsTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : GiveParishMethodsTableMap::translateFieldName('Value', TableMap::TYPE_PHPNAME, $indexType)];
            $this->value = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : GiveParishMethodsTableMap::translateFieldName('ParishId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->parish_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : GiveParishMethodsTableMap::translateFieldName('MethodId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->method_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : GiveParishMethodsTableMap::translateFieldName('Settings', TableMap::TYPE_PHPNAME, $indexType)];
            $this->settings = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : GiveParishMethodsTableMap::translateFieldName('Enabled', TableMap::TYPE_PHPNAME, $indexType)];
            $this->enabled = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : GiveParishMethodsTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 6; // 6 = GiveParishMethodsTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\GiveParishMethods'), 0, $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aGiveMethods !== null && $this->method_id !== $this->aGiveMethods->getValue()) {
            $this->aGiveMethods = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildGiveParishMethodsQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see GiveParishMethods::setDeleted()
     * @see GiveParishMethods::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildGiveParishMethodsQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                GiveParishMethodsTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doSave(ConnectionInterface $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aGiveMethods !== null) {
                if ($this->aGiveMethods->isModified() || $this->aGiveMethods->isNew()) {
                    $affectedRows += $this->aGiveMethods->save($con);
                }
                $this->setGiveMethods($this->aGiveMethods);
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(GiveParishMethodsTableMap::COL_VALUE)) {
            $modifiedColumns[':p' . $index++]  = 'value';
        }
        if ($this->isColumnModified(GiveParishMethodsTableMap::COL_PARISH_ID)) {
            $modifiedColumns[':p' . $index++]  = 'parish_id';
        }
        if ($this->isColumnModified(GiveParishMethodsTableMap::COL_METHOD_ID)) {
            $modifiedColumns[':p' . $index++]  = 'method_id';
        }
        if ($this->isColumnModified(GiveParishMethodsTableMap::COL_SETTINGS)) {
            $modifiedColumns[':p' . $index++]  = 'settings';
        }
        if ($this->isColumnModified(GiveParishMethodsTableMap::COL_ENABLED)) {
            $modifiedColumns[':p' . $index++]  = 'enabled';
        }
        if ($this->isColumnModified(GiveParishMethodsTableMap::COL_CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'created_at';
        }

        $sql = sprintf(
            'INSERT INTO give_parish_methods (%s) VALUES (%s)',
    ...
    {
        $pos = GiveParishMethodsTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['GiveParishMethods'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['GiveParishMethods'][$this->hashCode()] = true;
        $keys = GiveParishMethodsTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getValue(),
            $keys[1] => $this->getParishId(),
            $keys[2] => $this->getMethodId(),
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aGiveMethods) {
                ...
                $result[$key] = $this->aGiveMethods->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(GiveParishMethodsTableMap::COL_VALUE)) {
            $criteria->add(GiveParishMethodsTableMap::COL_VALUE, $this->value);
        }
        if ($this->isColumnModified(GiveParishMethodsTableMap::COL_PARISH_ID)) {
            $criteria->add(GiveParishMethodsTableMap::COL_PARISH_ID, $this->parish_id);
        }
        if ($this->isColumnModified(GiveParishMethodsTableMap::COL_METHOD_ID)) {
            $criteria->add(GiveParishMethodsTableMap::COL_METHOD_ID, $this->method_id);
        }
        if ($this->isColumnModified(GiveParishMethodsTableMap::COL_SETTINGS)) {
            $criteria->add(GiveParishMethodsTableMap::COL_SETTINGS, $this->settings);
        }
        if ($this->isColumnModified(GiveParishMethodsTableMap::COL_ENABLED)) {
            $criteria->add(GiveParishMethodsTableMap::COL_ENABLED, $this->enabled);
        }
        if ($this->isColumnModified(GiveParishMethodsTableMap::COL_CREATED_AT)) {
            $criteria->add(GiveParishMethodsTableMap::COL_CREATED_AT, $this->created_at);
        }
    ...
    {
        $criteria = ChildGiveParishMethodsQuery::create();
        $criteria->add(GiveParishMethodsTableMap::COL_VALUE, $this->value);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \GiveParishMethods (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \GiveParishMethods Clone of current object.
     * @throws PropelException
     */
    ...
    public function getParish(ConnectionInterface $con = null)
    {
        if ($this->aParish === null && ($this->parish_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aParish->addGiveParishMethodss($this);
             */
        }
    ...
    /**
     * Declares an association between this object and a ChildGiveMethods object.
     *
     * @param  ChildGiveMethods $v
     * @return $this|\GiveParishMethods The current object (for fluent API support)
     * @throws PropelException
     */
    public function setGiveMethods(ChildGiveMethods $v = null)
    {
        if ($v === null) {
        ...
        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the ChildGiveMethods object, it will not be re-added.
        if ($v !== null) {
            $v->addGiveParishMethods($this);
        }
    ...
    /**
     * Get the associated ChildGiveMethods object
     *
     * @param  ConnectionInterface $con Optional Connection object.
     * @return ChildGiveMethods The associated ChildGiveMethods object.
     * @throws PropelException
     */
    public function getGiveMethods(ConnectionInterface $con = null)
    {
        if ($this->aGiveMethods === null && ($this->method_id !== null)) {
            $this->aGiveMethods = ChildGiveMethodsQuery::create()->findPk($this->method_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aGiveMethods->addGiveParishMethodss($this);
             */
        }

        return $this->aGiveMethods;
    }
     ...
     * If this ChildGiveParishMethods is new, it will return
        ...
        if (null === $this->collGives || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collGives) {
                ...
                $collGives = ChildGiveQuery::create(null, $criteria)
                    ->filterByGiveParishMethods($this)
                    ->find($con);
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildGiveParishMethods The current object (for fluent API support)
     */
    public function setGives(Collection $gives, ConnectionInterface $con = null)
    {
        ...
        foreach ($givesToDelete as $giveRemoved) {
            $giveRemoved->setGiveParishMethods(null);
        }
    ...
    {
        $this->collGives[]= $give;
        $give->setGiveParishMethods($this);
    }
    ...
    public function removeGive(ChildGive $give)
    {
        if ($this->getGives()->contains($give)) {
            ...
            $give->setGiveParishMethods(null);
        }
     ...
     * Otherwise if this GiveParishMethods is new, it will return
     * an empty collection; or if this GiveParishMethods has previously
     * been saved, it will retrieve related Gives from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in GiveParishMethods.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    {
        if (null !== $this->aParish) {
            $this->aParish->removeGiveParishMethods($this);
        }
        if (null !== $this->aGiveMethods) {
            $this->aGiveMethods->removeGiveParishMethods($this);
        }
        $this->value = null;
        $this->parish_id = null;
        $this->method_id = null;
    ...
    {
        return (string) $this->exportTo(GiveParishMethodsTableMap::DEFAULT_STRING_FORMAT);
    }
