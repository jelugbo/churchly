...
abstract class Media implements ActiveRecordInterface 
{
    ...
    /**
     * The value for the publish_on field.
     * 
    ...
    /**
     * @var        ChildMediaCategories
     */
    protected $aMediaCategories;
    ...
    /**
     * Get the [optionally formatted] temporal [publish_on] column value.
     * 
     *
     ...
     */
    public function getPublishOn($format = NULL)
    {
        if ($format === null) {
            return $this->publish_on;
        } else {
            return $this->publish_on instanceof \DateTimeInterface ? $this->publish_on->format($format) : null;
        }
    }
    ...
    public function setValue($v)
    {
        ...
        if ($this->value !== $v) {
            $this->value = $v;
            $this->modifiedColumns[MediaTableMap::COL_VALUE] = true;
        }
    ...
    public function setParishId($v)
    {
        ...
        if ($this->parish_id !== $v) {
            $this->parish_id = $v;
            $this->modifiedColumns[MediaTableMap::COL_PARISH_ID] = true;
        }
    ...
    public function setCategory($v)
    {
        ...
        if ($this->category !== $v) {
            $this->category = $v;
            $this->modifiedColumns[MediaTableMap::COL_CATEGORY] = true;
        }

        if ($this->aMediaCategories !== null && $this->aMediaCategories->getValue() !== $v) {
            $this->aMediaCategories = null;
        }
    ...
    /**
     * Sets the value of [publish_on] column to a normalized version of the date/time value specified.
     * 
     * @param  mixed $v string, integer (timestamp), or \DateTimeInterface value.
     *               Empty strings are treated as NULL.
     * @return $this|\Media The current object (for fluent API support)
     */
    public function setPublishOn($v)
    {
        $dt = PropelDateTime::newInstance($v, null, 'DateTime');
        if ($this->publish_on !== null || $dt !== null) {
            if ($this->publish_on === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->publish_on->format("Y-m-d H:i:s.u")) {
                $this->publish_on = $dt === null ? null : clone $dt;
                $this->modifiedColumns[MediaTableMap::COL_PUBLISH_ON] = true;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : MediaTableMap::translateFieldName('Value', TableMap::TYPE_PHPNAME, $indexType)];
            $this->value = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : MediaTableMap::translateFieldName('ParishId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : MediaTableMap::translateFieldName('Category', TableMap::TYPE_PHPNAME, $indexType)];
            $this->category = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : MediaTableMap::translateFieldName('Type', TableMap::TYPE_PHPNAME, $indexType)];
            $this->type = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : MediaTableMap::translateFieldName('Url', TableMap::TYPE_PHPNAME, $indexType)];
            $this->url = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : MediaTableMap::translateFieldName('PublishOn', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->publish_on = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : MediaTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 8; // 8 = MediaTableMap::NUM_HYDRATE_COLUMNS.
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aMediaCategories !== null && $this->category !== $this->aMediaCategories->getValue()) {
            $this->aMediaCategories = null;
        }
    ...
    protected function doSave(ConnectionInterface $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aMediaCategories !== null) {
                if ($this->aMediaCategories->isModified() || $this->aMediaCategories->isNew()) {
                    $affectedRows += $this->aMediaCategories->save($con);
                }
                $this->setMediaCategories($this->aMediaCategories);
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[MediaTableMap::COL_VALUE] = true;
        if (null !== $this->value) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . MediaTableMap::COL_VALUE . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(MediaTableMap::COL_VALUE)) {
            $modifiedColumns[':p' . $index++]  = 'value';
        }
        if ($this->isColumnModified(MediaTableMap::COL_PARISH_ID)) {
            $modifiedColumns[':p' . $index++]  = 'parish_id';
        }
        if ($this->isColumnModified(MediaTableMap::COL_TITLE)) {
            $modifiedColumns[':p' . $index++]  = 'title';
        }
        if ($this->isColumnModified(MediaTableMap::COL_CATEGORY)) {
        ...
        if ($this->isColumnModified(MediaTableMap::COL_PUBLISH_ON)) {
            $modifiedColumns[':p' . $index++]  = 'publish_on';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'url':                        
                        ...
                        break;
                    case 'publish_on':                        
                        $stmt->bindValue($identifier, $this->publish_on ? $this->publish_on->format("Y-m-d H:i:s.u") : null, PDO::PARAM_STR);
                        break;
                    case 'created_at':                        
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aMediaCategories) {
                ...
                $result[$key] = $this->aMediaCategories->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(MediaTableMap::COL_VALUE)) {
            $criteria->add(MediaTableMap::COL_VALUE, $this->value);
        }
        if ($this->isColumnModified(MediaTableMap::COL_PARISH_ID)) {
            $criteria->add(MediaTableMap::COL_PARISH_ID, $this->parish_id);
        }
        if ($this->isColumnModified(MediaTableMap::COL_TITLE)) {
            $criteria->add(MediaTableMap::COL_TITLE, $this->title);
        }
        if ($this->isColumnModified(MediaTableMap::COL_CATEGORY)) {
            $criteria->add(MediaTableMap::COL_CATEGORY, $this->category);
        }
        if ($this->isColumnModified(MediaTableMap::COL_TYPE)) {
        ...
        if ($this->isColumnModified(MediaTableMap::COL_PUBLISH_ON)) {
            $criteria->add(MediaTableMap::COL_PUBLISH_ON, $this->publish_on);
        }
        if ($this->isColumnModified(MediaTableMap::COL_CREATED_AT)) {
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setPublishOn($this->getPublishOn());
    ...
    /**
     * Declares an association between this object and a ChildMediaCategories object.
     *
     * @param  ChildMediaCategories $v
     * @return $this|\Media The current object (for fluent API support)
     * @throws PropelException
     */
    public function setMediaCategories(ChildMediaCategories $v = null)
    {
        if ($v === null) {
            $this->setCategory(NULL);
        } else {
            $this->setCategory($v->getValue());
        }

        $this->aMediaCategories = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the ChildMediaCategories object, it will not be re-added.
        if ($v !== null) {
            $v->addMedia($this);
        }
    ...
    /**
     * Get the associated ChildMediaCategories object
     *
     * @param  ConnectionInterface $con Optional Connection object.
     * @return ChildMediaCategories The associated ChildMediaCategories object.
     * @throws PropelException
     */
    public function getMediaCategories(ConnectionInterface $con = null)
    {
        if ($this->aMediaCategories === null && ($this->category !== null)) {
            $this->aMediaCategories = ChildMediaCategoriesQuery::create()->findPk($this->category, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aMediaCategories->addMedias($this);
             */
        }

        return $this->aMediaCategories;
    }
    ...
    {
        if (null !== $this->aParish) {
            $this->aParish->removeMedia($this);
        }
        if (null !== $this->aMediaCategories) {
            $this->aMediaCategories->removeMedia($this);
        }
        if (null !== $this->aMediaType) {
            $this->aMediaType->removeMedia($this);
        }
        $this->value = null;
        $this->parish_id = null;
        $this->title = null;
