...
/**
 * Base class that represents a row from the 'letter_type' table.
 *
 * 
 *
 * @package    propel.generator..Base
 */
abstract class LetterType implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\LetterTypeTableMap';
    ...
    /**
     * Initializes internal state of Base\LetterType object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>LetterType</code> instance.  If
     * <code>obj</code> is an instance of <code>LetterType</code>, delegates to
     * <code>equals(LetterType)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|LetterType The current object, for fluid interface
     */
     ...
     * @return $this|\LetterType The current object (for fluent API support)
     */
    public function setValue($v)
    {
        ...
        if ($this->value !== $v) {
            $this->value = $v;
            $this->modifiedColumns[LetterTypeTableMap::COL_VALUE] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[LetterTypeTableMap::COL_NAME] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[LetterTypeTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : LetterTypeTableMap::translateFieldName('Value', TableMap::TYPE_PHPNAME, $indexType)];
            $this->value = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : LetterTypeTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : LetterTypeTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = LetterTypeTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\LetterType'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildLetterTypeQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see LetterType::setDeleted()
     * @see LetterType::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildLetterTypeQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                LetterTypeTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(LetterTypeTableMap::COL_VALUE)) {
            $modifiedColumns[':p' . $index++]  = 'value';
        }
        if ($this->isColumnModified(LetterTypeTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(LetterTypeTableMap::COL_CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'created_at';
        }

        $sql = sprintf(
            'INSERT INTO letter_type (%s) VALUES (%s)',
    ...
    {
        $pos = LetterTypeTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['LetterType'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['LetterType'][$this->hashCode()] = true;
        $keys = LetterTypeTableMap::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(LetterTypeTableMap::COL_VALUE)) {
            $criteria->add(LetterTypeTableMap::COL_VALUE, $this->value);
        }
        if ($this->isColumnModified(LetterTypeTableMap::COL_NAME)) {
            $criteria->add(LetterTypeTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(LetterTypeTableMap::COL_CREATED_AT)) {
            $criteria->add(LetterTypeTableMap::COL_CREATED_AT, $this->created_at);
        }
    ...
    {
        $criteria = ChildLetterTypeQuery::create();
        $criteria->add(LetterTypeTableMap::COL_VALUE, $this->value);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \LetterType (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \LetterType Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildLetterType is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildLetterType The current object (for fluent API support)
     */
    public function setLetterss(Collection $letterss, ConnectionInterface $con = null)
    {
        ...
        foreach ($letterssToDelete as $lettersRemoved) {
            $lettersRemoved->setLetterType(null);
        }
     ...
     * Otherwise if this LetterType is new, it will return
     * an empty collection; or if this LetterType has previously
     * been saved, it will retrieve related Letterss from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in LetterType.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildLetters[] List of ChildLetters objects
     */
    public function getLetterssJoinParish(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildLettersQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(LetterTypeTableMap::DEFAULT_STRING_FORMAT);
    }
