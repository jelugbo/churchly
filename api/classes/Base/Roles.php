...
abstract class Roles implements ActiveRecordInterface 
{
    ...
    public function setValue($v)
    {
        ...
        if ($this->value !== $v) {
            $this->value = $v;
            $this->modifiedColumns[RolesTableMap::COL_VALUE] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[RolesTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : RolesTableMap::translateFieldName('Value', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : RolesTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(RolesTableMap::COL_VALUE)) {
            $modifiedColumns[':p' . $index++]  = 'value';
        }
        if ($this->isColumnModified(RolesTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(RolesTableMap::COL_CREATED_AT)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(RolesTableMap::COL_VALUE)) {
            $criteria->add(RolesTableMap::COL_VALUE, $this->value);
        }
        if ($this->isColumnModified(RolesTableMap::COL_NAME)) {
            $criteria->add(RolesTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(RolesTableMap::COL_CREATED_AT)) {
            $criteria->add(RolesTableMap::COL_CREATED_AT, $this->created_at);
        }
    ...
    public function setMenuRoless(Collection $menuRoless, ConnectionInterface $con = null)
    {
        ...
        foreach ($menuRolessToDelete as $menuRolesRemoved) {
            $menuRolesRemoved->setRoles(null);
        }
     ...
     * @return ObjectCollection|ChildMenuRoles[] List of ChildMenuRoles objects
     */
    public function getMenuRolessJoinMenu(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildMenuRolesQuery::create(null, $criteria);
    ...
    public function setUserLogins(Collection $userLogins, ConnectionInterface $con = null)
    {
        ...
        foreach ($userLoginsToDelete as $userLoginRemoved) {
            $userLoginRemoved->setRoles(null);
        }
     ...
     * @return ObjectCollection|ChildUserLogin[] List of ChildUserLogin objects
     */
    public function getUserLoginsJoinParish(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildUserLoginQuery::create(null, $criteria);
