...
/**
 * Base class that represents a row from the 'media_categories' table.
 *
 * 
 *
 * @package    propel.generator..Base
 */
abstract class MediaCategories implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\MediaCategoriesTableMap';
    ...
    /**
     * Initializes internal state of Base\MediaCategories object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>MediaCategories</code> instance.  If
     * <code>obj</code> is an instance of <code>MediaCategories</code>, delegates to
     * <code>equals(MediaCategories)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|MediaCategories The current object, for fluid interface
     */
     ...
     * @return $this|\MediaCategories The current object (for fluent API support)
     */
    public function setValue($v)
    {
        ...
        if ($this->value !== $v) {
            $this->value = $v;
            $this->modifiedColumns[MediaCategoriesTableMap::COL_VALUE] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[MediaCategoriesTableMap::COL_NAME] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[MediaCategoriesTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : MediaCategoriesTableMap::translateFieldName('Value', TableMap::TYPE_PHPNAME, $indexType)];
            $this->value = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : MediaCategoriesTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : MediaCategoriesTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = MediaCategoriesTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\MediaCategories'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildMediaCategoriesQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see MediaCategories::setDeleted()
     * @see MediaCategories::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildMediaCategoriesQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                MediaCategoriesTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[MediaCategoriesTableMap::COL_VALUE] = true;
        if (null !== $this->value) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . MediaCategoriesTableMap::COL_VALUE . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(MediaCategoriesTableMap::COL_VALUE)) {
            $modifiedColumns[':p' . $index++]  = 'value';
        }
        if ($this->isColumnModified(MediaCategoriesTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(MediaCategoriesTableMap::COL_CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'created_at';
        }

        $sql = sprintf(
            'INSERT INTO media_categories (%s) VALUES (%s)',
    ...
    {
        $pos = MediaCategoriesTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['MediaCategories'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['MediaCategories'][$this->hashCode()] = true;
        $keys = MediaCategoriesTableMap::getFieldNames($keyType);
        $result = array(
    ...
    {
        $criteria = new Criteria(MediaCategoriesTableMap::DATABASE_NAME);

        if ($this->isColumnModified(MediaCategoriesTableMap::COL_VALUE)) {
            $criteria->add(MediaCategoriesTableMap::COL_VALUE, $this->value);
        }
        if ($this->isColumnModified(MediaCategoriesTableMap::COL_NAME)) {
            $criteria->add(MediaCategoriesTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(MediaCategoriesTableMap::COL_CREATED_AT)) {
            $criteria->add(MediaCategoriesTableMap::COL_CREATED_AT, $this->created_at);
        }
    ...
    {
        $criteria = ChildMediaCategoriesQuery::create();
        $criteria->add(MediaCategoriesTableMap::COL_VALUE, $this->value);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \MediaCategories (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \MediaCategories Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildMediaCategories is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildMediaCategories The current object (for fluent API support)
     */
    public function setMedias(Collection $medias, ConnectionInterface $con = null)
    {
        ...
        foreach ($mediasToDelete as $mediaRemoved) {
            $mediaRemoved->setMediaCategories(null);
        }
     ...
     * Otherwise if this MediaCategories is new, it will return
     * an empty collection; or if this MediaCategories has previously
     * been saved, it will retrieve related Medias from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in MediaCategories.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildMedia[] List of ChildMedia objects
     */
    public function getMediasJoinParish(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildMediaQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(MediaCategoriesTableMap::DEFAULT_STRING_FORMAT);
    }
