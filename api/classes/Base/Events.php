...
abstract class Events implements ActiveRecordInterface 
{
    ...
    public function setValue($v)
    {
        ...
        if ($this->value !== $v) {
            $this->value = $v;
            $this->modifiedColumns[EventsTableMap::COL_VALUE] = true;
        }
    ...
    public function setParishId($v)
    {
        ...
        if ($this->parish_id !== $v) {
            $this->parish_id = $v;
            $this->modifiedColumns[EventsTableMap::COL_PARISH_ID] = true;
        }
    ...
    public function setVenue($v)
    {
        ...
        if ($this->venue !== $v) {
            $this->venue = $v;
            $this->modifiedColumns[EventsTableMap::COL_VENUE] = true;
        }
    ...
    public function setStartDate($v)
    {
        ...
        if ($this->start_date !== null || $dt !== null) {
            if ($this->start_date === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->start_date->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[EventsTableMap::COL_START_DATE] = true;
            }
    ...
    public function setStartTime($v)
    {
        ...
        if ($this->start_time !== $v) {
            $this->start_time = $v;
            $this->modifiedColumns[EventsTableMap::COL_START_TIME] = true;
        }
    ...
    public function setEndDate($v)
    {
        ...
        if ($this->end_date !== null || $dt !== null) {
            if ($this->end_date === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->end_date->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[EventsTableMap::COL_END_DATE] = true;
            }
        } // if either are not null
    ...
    public function setEndTime($v)
    {
        ...
        if ($this->end_time !== $v) {
            $this->end_time = $v;
            $this->modifiedColumns[EventsTableMap::COL_END_TIME] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[EventsTableMap::COL_CREATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : EventsTableMap::translateFieldName('Value', TableMap::TYPE_PHPNAME, $indexType)];
            $this->value = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : EventsTableMap::translateFieldName('ParishId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->parish_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : EventsTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : EventsTableMap::translateFieldName('Venue', TableMap::TYPE_PHPNAME, $indexType)];
            $this->venue = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : EventsTableMap::translateFieldName('StartDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->start_date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : EventsTableMap::translateFieldName('StartTime', TableMap::TYPE_PHPNAME, $indexType)];
            $this->start_time = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : EventsTableMap::translateFieldName('EndDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->end_date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : EventsTableMap::translateFieldName('EndTime', TableMap::TYPE_PHPNAME, $indexType)];
            $this->end_time = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : EventsTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 9; // 9 = EventsTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(EventsTableMap::COL_VALUE)) {
            $modifiedColumns[':p' . $index++]  = 'value';
        }
        if ($this->isColumnModified(EventsTableMap::COL_PARISH_ID)) {
            $modifiedColumns[':p' . $index++]  = 'parish_id';
        }
        if ($this->isColumnModified(EventsTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(EventsTableMap::COL_VENUE)) {
            $modifiedColumns[':p' . $index++]  = 'venue';
        }
        if ($this->isColumnModified(EventsTableMap::COL_START_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'start_date';
        }
        if ($this->isColumnModified(EventsTableMap::COL_START_TIME)) {
            $modifiedColumns[':p' . $index++]  = 'start_time';
        }
        if ($this->isColumnModified(EventsTableMap::COL_END_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'end_date';
        }
        if ($this->isColumnModified(EventsTableMap::COL_END_TIME)) {
            $modifiedColumns[':p' . $index++]  = 'end_time';
        }
        if ($this->isColumnModified(EventsTableMap::COL_CREATED_AT)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'name':                        
                        ...
                        break;
                    case 'venue':                        
                        $stmt->bindValue($identifier, $this->venue, PDO::PARAM_STR);
                        break;
                    case 'start_date':                        
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(EventsTableMap::COL_VALUE)) {
            $criteria->add(EventsTableMap::COL_VALUE, $this->value);
        }
        if ($this->isColumnModified(EventsTableMap::COL_PARISH_ID)) {
            $criteria->add(EventsTableMap::COL_PARISH_ID, $this->parish_id);
        }
        if ($this->isColumnModified(EventsTableMap::COL_NAME)) {
            $criteria->add(EventsTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(EventsTableMap::COL_VENUE)) {
            $criteria->add(EventsTableMap::COL_VENUE, $this->venue);
        }
        if ($this->isColumnModified(EventsTableMap::COL_START_DATE)) {
            $criteria->add(EventsTableMap::COL_START_DATE, $this->start_date);
        }
        if ($this->isColumnModified(EventsTableMap::COL_START_TIME)) {
            $criteria->add(EventsTableMap::COL_START_TIME, $this->start_time);
        }
        if ($this->isColumnModified(EventsTableMap::COL_END_DATE)) {
            $criteria->add(EventsTableMap::COL_END_DATE, $this->end_date);
        }
        if ($this->isColumnModified(EventsTableMap::COL_END_TIME)) {
            $criteria->add(EventsTableMap::COL_END_TIME, $this->end_time);
        }
        if ($this->isColumnModified(EventsTableMap::COL_CREATED_AT)) {
            $criteria->add(EventsTableMap::COL_CREATED_AT, $this->created_at);
        }
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setVenue($this->getVenue());
    ...
    {
        if (null !== $this->aParish) {
            $this->aParish->removeEvents($this);
        }
        $this->value = null;
        $this->parish_id = null;
        $this->name = null;
