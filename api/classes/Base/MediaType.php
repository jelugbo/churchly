...
/**
 * Base class that represents a row from the 'media_type' table.
 *
 * 
 *
 * @package    propel.generator..Base
 */
abstract class MediaType implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\MediaTypeTableMap';
    ...
    /**
     * Initializes internal state of Base\MediaType object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>MediaType</code> instance.  If
     * <code>obj</code> is an instance of <code>MediaType</code>, delegates to
     * <code>equals(MediaType)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|MediaType The current object, for fluid interface
     */
     ...
     * @return $this|\MediaType The current object (for fluent API support)
     */
    public function setValue($v)
    {
        ...
        if ($this->value !== $v) {
            $this->value = $v;
            $this->modifiedColumns[MediaTypeTableMap::COL_VALUE] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[MediaTypeTableMap::COL_NAME] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[MediaTypeTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : MediaTypeTableMap::translateFieldName('Value', TableMap::TYPE_PHPNAME, $indexType)];
            $this->value = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : MediaTypeTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : MediaTypeTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = MediaTypeTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\MediaType'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildMediaTypeQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see MediaType::setDeleted()
     * @see MediaType::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildMediaTypeQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                MediaTypeTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[MediaTypeTableMap::COL_VALUE] = true;
        if (null !== $this->value) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . MediaTypeTableMap::COL_VALUE . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(MediaTypeTableMap::COL_VALUE)) {
            $modifiedColumns[':p' . $index++]  = 'value';
        }
        if ($this->isColumnModified(MediaTypeTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'Name';
        }
        if ($this->isColumnModified(MediaTypeTableMap::COL_CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'created_at';
        }

        $sql = sprintf(
            'INSERT INTO media_type (%s) VALUES (%s)',
    ...
    {
        $pos = MediaTypeTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['MediaType'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['MediaType'][$this->hashCode()] = true;
        $keys = MediaTypeTableMap::getFieldNames($keyType);
        $result = array(
    ...
    {
        $criteria = new Criteria(MediaTypeTableMap::DATABASE_NAME);

        if ($this->isColumnModified(MediaTypeTableMap::COL_VALUE)) {
            $criteria->add(MediaTypeTableMap::COL_VALUE, $this->value);
        }
        if ($this->isColumnModified(MediaTypeTableMap::COL_NAME)) {
            $criteria->add(MediaTypeTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(MediaTypeTableMap::COL_CREATED_AT)) {
            $criteria->add(MediaTypeTableMap::COL_CREATED_AT, $this->created_at);
        }
    ...
    {
        $criteria = ChildMediaTypeQuery::create();
        $criteria->add(MediaTypeTableMap::COL_VALUE, $this->value);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \MediaType (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \MediaType Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildMediaType is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildMediaType The current object (for fluent API support)
     */
    public function setDevotionss(Collection $devotionss, ConnectionInterface $con = null)
    {
        ...
        foreach ($devotionssToDelete as $devotionsRemoved) {
            $devotionsRemoved->setMediaType(null);
        }
     ...
     * @return ObjectCollection|ChildDevotions[] List of ChildDevotions objects
     */
    public function getDevotionssJoinParish(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildDevotionsQuery::create(null, $criteria);
    ...
    public function setMedias(Collection $medias, ConnectionInterface $con = null)
    {
        ...
        foreach ($mediasToDelete as $mediaRemoved) {
            $mediaRemoved->setMediaType(null);
        }
    ...
    {
        return (string) $this->exportTo(MediaTypeTableMap::DEFAULT_STRING_FORMAT);
    }
