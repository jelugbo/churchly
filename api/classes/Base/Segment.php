...
/**
 * Base class that represents a row from the 'segment' table.
 *
 * 
 *
 * @package    propel.generator..Base
 */
abstract class Segment implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\SegmentTableMap';
    ...
    /**
     * The value for the ssl_cert field.
     * 
     * @var        string
     */
    protected $ssl_cert;
    ...
    /**
     * The value for the pwd_cert field.
     * 
     * @var        string
     */
    protected $pwd_cert;
    ...
    /**
     * The value for the send_limit field.
     * 
     * @var        int
     */
    ...
    /**
     * Initializes internal state of Base\Segment object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>Segment</code> instance.  If
     * <code>obj</code> is an instance of <code>Segment</code>, delegates to
     * <code>equals(Segment)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Segment The current object, for fluid interface
     */
    ...
    /**
     * Get the [pwd_cert] column value.
     * 
     * @return string
     */
    public function getPwdCert()
    {
        return $this->pwd_cert;
    }

    /**
     * Get the [send_limit] column value.
     * 
     * @return int
     */
     ...
     * @return $this|\Segment The current object (for fluent API support)
     */
    public function setValue($v)
    {
        ...
        if ($this->value !== $v) {
            $this->value = $v;
            $this->modifiedColumns[SegmentTableMap::COL_VALUE] = true;
        }
    ...
    public function setCode($v)
    {
        ...
        if ($this->code !== $v) {
            $this->code = $v;
            $this->modifiedColumns[SegmentTableMap::COL_CODE] = true;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[SegmentTableMap::COL_DESCRIPTION] = true;
        }
    ...
    public function setProjectId($v)
    {
        ...
        if ($this->project_id !== $v) {
            $this->project_id = $v;
            $this->modifiedColumns[SegmentTableMap::COL_PROJECT_ID] = true;
        }
    ...
    public function setProjectNumber($v)
    {
        ...
        if ($this->project_number !== $v) {
            ...
            $this->modifiedColumns[SegmentTableMap::COL_PROJECT_NUMBER] = true;
        }
    ...
    public function setApiKey($v)
    {
        ...
        if ($this->api_key !== $v) {
            $this->api_key = $v;
            $this->modifiedColumns[SegmentTableMap::COL_API_KEY] = true;
        }
    ...
    /**
     * Set the value of [ssl_cert] column.
     * 
     * @param string $v new value
     * @return $this|\Segment The current object (for fluent API support)
     */
    public function setSslCert($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->ssl_cert !== $v) {
            $this->ssl_cert = $v;
            $this->modifiedColumns[SegmentTableMap::COL_SSL_CERT] = true;
        }
    ...
    /**
     * Set the value of [pwd_cert] column.
     * 
     * @param string $v new value
     * @return $this|\Segment The current object (for fluent API support)
     */
    public function setPwdCert($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->pwd_cert !== $v) {
            $this->pwd_cert = $v;
            $this->modifiedColumns[SegmentTableMap::COL_PWD_CERT] = true;
        }
    ...
    /**
     * Set the value of [send_limit] column.
     * 
     * @param int $v new value
     * @return $this|\Segment The current object (for fluent API support)
     */
    public function setSendLimit($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->send_limit !== $v) {
            $this->send_limit = $v;
            $this->modifiedColumns[SegmentTableMap::COL_SEND_LIMIT] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[SegmentTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : SegmentTableMap::translateFieldName('Value', TableMap::TYPE_PHPNAME, $indexType)];
            $this->value = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SegmentTableMap::translateFieldName('Code', TableMap::TYPE_PHPNAME, $indexType)];
            $this->code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : SegmentTableMap::translateFieldName('Description', TableMap::TYPE_PHPNAME, $indexType)];
            $this->description = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : SegmentTableMap::translateFieldName('ProjectId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->project_id = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : SegmentTableMap::translateFieldName('ProjectNumber', TableMap::TYPE_PHPNAME, $indexType)];
            $this->project_number = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : SegmentTableMap::translateFieldName('ApiKey', TableMap::TYPE_PHPNAME, $indexType)];
            $this->api_key = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : SegmentTableMap::translateFieldName('SslCert', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ssl_cert = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : SegmentTableMap::translateFieldName('PwdCert', TableMap::TYPE_PHPNAME, $indexType)];
            $this->pwd_cert = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : SegmentTableMap::translateFieldName('SendLimit', TableMap::TYPE_PHPNAME, $indexType)];
            $this->send_limit = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : SegmentTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 10; // 10 = SegmentTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Segment'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildSegmentQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Segment::setDeleted()
     * @see Segment::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildSegmentQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                SegmentTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[SegmentTableMap::COL_VALUE] = true;
        if (null !== $this->value) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . SegmentTableMap::COL_VALUE . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(SegmentTableMap::COL_VALUE)) {
            $modifiedColumns[':p' . $index++]  = 'value';
        }
        if ($this->isColumnModified(SegmentTableMap::COL_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'code';
        }
        if ($this->isColumnModified(SegmentTableMap::COL_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = 'description';
        }
        if ($this->isColumnModified(SegmentTableMap::COL_PROJECT_ID)) {
            $modifiedColumns[':p' . $index++]  = 'project_id';
        }
        if ($this->isColumnModified(SegmentTableMap::COL_PROJECT_NUMBER)) {
            $modifiedColumns[':p' . $index++]  = 'project_number';
        }
        if ($this->isColumnModified(SegmentTableMap::COL_API_KEY)) {
            $modifiedColumns[':p' . $index++]  = 'api_key';
        }
        if ($this->isColumnModified(SegmentTableMap::COL_SSL_CERT)) {
            $modifiedColumns[':p' . $index++]  = 'ssl_cert';
        }
        if ($this->isColumnModified(SegmentTableMap::COL_PWD_CERT)) {
            $modifiedColumns[':p' . $index++]  = 'pwd_cert';
        }
        if ($this->isColumnModified(SegmentTableMap::COL_SEND_LIMIT)) {
            $modifiedColumns[':p' . $index++]  = 'send_limit';
        }
        if ($this->isColumnModified(SegmentTableMap::COL_CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'created_at';
        }

        $sql = sprintf(
            'INSERT INTO segment (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'project_id':                        
                        ...
                        break;
                    case 'project_number':                        
                        $stmt->bindValue($identifier, $this->project_number, PDO::PARAM_STR);
                        break;
                    case 'api_key':                        
                        $stmt->bindValue($identifier, $this->api_key, PDO::PARAM_STR);
                        break;
                    case 'ssl_cert':                        
                        $stmt->bindValue($identifier, $this->ssl_cert, PDO::PARAM_STR);
                        break;
                    case 'pwd_cert':                        
                        $stmt->bindValue($identifier, $this->pwd_cert, PDO::PARAM_STR);
                        break;
                    case 'send_limit':                        
                        $stmt->bindValue($identifier, $this->send_limit, PDO::PARAM_INT);
                        break;
                    case 'created_at':                        
    ...
    {
        $pos = SegmentTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 6:
                ...
                break;
            case 7:
                return $this->getPwdCert();
                break;
            case 8:
                return $this->getSendLimit();
                break;
            case 9:
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Segment'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Segment'][$this->hashCode()] = true;
        $keys = SegmentTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getValue(),
            $keys[1] => $this->getCode(),
            $keys[2] => $this->getDescription(),
            $keys[3] => $this->getProjectId(),
            $keys[4] => $this->getProjectNumber(),
            $keys[5] => $this->getApiKey(),
            $keys[6] => $this->getSslCert(),
            $keys[7] => $this->getPwdCert(),
            $keys[8] => $this->getSendLimit(),
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 5:
                ...
                break;
            case 6:
                $this->setSslCert($value);
                break;
            case 7:
                $this->setPwdCert($value);
                break;
            case 8:
                $this->setSendLimit($value);
                break;
            case 9:
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[4], $arr)) {
            $this->setProjectNumber($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setApiKey($arr[$keys[5]]);
        }
        if (array_key_exists($keys[6], $arr)) {
            $this->setSslCert($arr[$keys[6]]);
        }
        if (array_key_exists($keys[7], $arr)) {
            $this->setPwdCert($arr[$keys[7]]);
        }
        if (array_key_exists($keys[8], $arr)) {
            $this->setSendLimit($arr[$keys[8]]);
        }
    ...
    {
        $criteria = new Criteria(SegmentTableMap::DATABASE_NAME);

        if ($this->isColumnModified(SegmentTableMap::COL_VALUE)) {
            $criteria->add(SegmentTableMap::COL_VALUE, $this->value);
        }
        if ($this->isColumnModified(SegmentTableMap::COL_CODE)) {
            $criteria->add(SegmentTableMap::COL_CODE, $this->code);
        }
        if ($this->isColumnModified(SegmentTableMap::COL_DESCRIPTION)) {
            $criteria->add(SegmentTableMap::COL_DESCRIPTION, $this->description);
        }
        if ($this->isColumnModified(SegmentTableMap::COL_PROJECT_ID)) {
            $criteria->add(SegmentTableMap::COL_PROJECT_ID, $this->project_id);
        }
        if ($this->isColumnModified(SegmentTableMap::COL_PROJECT_NUMBER)) {
            $criteria->add(SegmentTableMap::COL_PROJECT_NUMBER, $this->project_number);
        }
        if ($this->isColumnModified(SegmentTableMap::COL_API_KEY)) {
            $criteria->add(SegmentTableMap::COL_API_KEY, $this->api_key);
        }
        if ($this->isColumnModified(SegmentTableMap::COL_SSL_CERT)) {
            $criteria->add(SegmentTableMap::COL_SSL_CERT, $this->ssl_cert);
        }
        if ($this->isColumnModified(SegmentTableMap::COL_PWD_CERT)) {
            $criteria->add(SegmentTableMap::COL_PWD_CERT, $this->pwd_cert);
        }
        if ($this->isColumnModified(SegmentTableMap::COL_SEND_LIMIT)) {
            $criteria->add(SegmentTableMap::COL_SEND_LIMIT, $this->send_limit);
        }
        if ($this->isColumnModified(SegmentTableMap::COL_CREATED_AT)) {
            $criteria->add(SegmentTableMap::COL_CREATED_AT, $this->created_at);
        }
    ...
    {
        $criteria = ChildSegmentQuery::create();
        $criteria->add(SegmentTableMap::COL_VALUE, $this->value);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Segment (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setProjectNumber($this->getProjectNumber());
        $copyObj->setApiKey($this->getApiKey());
        $copyObj->setSslCert($this->getSslCert());
        $copyObj->setPwdCert($this->getPwdCert());
        $copyObj->setSendLimit($this->getSendLimit());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Segment Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildSegment is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildSegment The current object (for fluent API support)
     */
    public function setParishSegments(Collection $parishSegments, ConnectionInterface $con = null)
    {
        ...
        foreach ($parishSegmentsToDelete as $parishSegmentRemoved) {
            $parishSegmentRemoved->setSegment(null);
        }
     ...
     * Otherwise if this Segment is new, it will return
     * an empty collection; or if this Segment has previously
     * been saved, it will retrieve related ParishSegments from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Segment.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildParishSegment[] List of ChildParishSegment objects
     */
    public function getParishSegmentsJoinParish(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildParishSegmentQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(SegmentTableMap::DEFAULT_STRING_FORMAT);
    }
