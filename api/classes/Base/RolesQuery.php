 ...
 * 
 *
 * @method     ChildRolesQuery orderByValue($order = Criteria::ASC) Order by the value column
 * @method     ChildRolesQuery orderByName($order = Criteria::ASC) Order by the name column
 * @method     ChildRolesQuery orderByCreatedAt($order = Criteria::ASC) Order by the created_at column
 *
 * @method     ChildRolesQuery groupByValue() Group by the value column
 * @method     ChildRolesQuery groupByName() Group by the name column
 * @method     ChildRolesQuery groupByCreatedAt() Group by the created_at column
 *
 ...
 *
 * @method     ChildRolesQuery leftJoinMenuRoles($relationAlias = null) Adds a LEFT JOIN clause to the query using the MenuRoles relation
 * @method     ChildRolesQuery rightJoinMenuRoles($relationAlias = null) Adds a RIGHT JOIN clause to the query using the MenuRoles relation
 * @method     ChildRolesQuery innerJoinMenuRoles($relationAlias = null) Adds a INNER JOIN clause to the query using the MenuRoles relation
 *
 * @method     ChildRolesQuery joinWithMenuRoles($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the MenuRoles relation
 *
 * @method     ChildRolesQuery leftJoinWithMenuRoles() Adds a LEFT JOIN clause and with to the query using the MenuRoles relation
 * @method     ChildRolesQuery rightJoinWithMenuRoles() Adds a RIGHT JOIN clause and with to the query using the MenuRoles relation
 * @method     ChildRolesQuery innerJoinWithMenuRoles() Adds a INNER JOIN clause and with to the query using the MenuRoles relation
 *
 * @method     ChildRolesQuery leftJoinUserLogin($relationAlias = null) Adds a LEFT JOIN clause to the query using the UserLogin relation
 * @method     ChildRolesQuery rightJoinUserLogin($relationAlias = null) Adds a RIGHT JOIN clause to the query using the UserLogin relation
 * @method     ChildRolesQuery innerJoinUserLogin($relationAlias = null) Adds a INNER JOIN clause to the query using the UserLogin relation
 *
 * @method     ChildRolesQuery joinWithUserLogin($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the UserLogin relation
 *
 * @method     ChildRolesQuery leftJoinWithUserLogin() Adds a LEFT JOIN clause and with to the query using the UserLogin relation
 * @method     ChildRolesQuery rightJoinWithUserLogin() Adds a RIGHT JOIN clause and with to the query using the UserLogin relation
 * @method     ChildRolesQuery innerJoinWithUserLogin() Adds a INNER JOIN clause and with to the query using the UserLogin relation
 *
 * @method     \MenuRolesQuery|\UserLoginQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 *
 * @method     ChildRoles findOneByValue(int $value) Return the first ChildRoles filtered by the value column
 * @method     ChildRoles findOneByName(string $name) Return the first ChildRoles filtered by the name column
 * @method     ChildRoles findOneByCreatedAt(string $created_at) Return the first ChildRoles filtered by the created_at column *
 ...
 *
 * @method     ChildRoles requireOneByValue(int $value) Return the first ChildRoles filtered by the value column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildRoles requireOneByCreatedAt(string $created_at) Return the first ChildRoles filtered by the created_at column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildRoles[]|ObjectCollection findByValue(int $value) Return ChildRoles objects filtered by the value column
 * @method     ChildRoles[]|ObjectCollection findByName(string $name) Return ChildRoles objects filtered by the name column
 * @method     ChildRoles[]|ObjectCollection findByCreatedAt(string $created_at) Return ChildRoles objects filtered by the created_at column
...
abstract class RolesQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'default', $modelName = '\\Roles', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT value, name, created_at FROM roles WHERE value = :p0';
        try {
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(RolesTableMap::COL_VALUE, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(RolesTableMap::COL_VALUE, $keys, Criteria::IN);
    }
    ...
    public function filterByValue($value = null, $comparison = null)
    {
        if (is_array($value)) {
            $useMinMax = false;
            if (isset($value['min'])) {
                $this->addUsingAlias(RolesTableMap::COL_VALUE, $value['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($value['max'])) {
                $this->addUsingAlias(RolesTableMap::COL_VALUE, $value['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(RolesTableMap::COL_VALUE, $value, $comparison);
    }
    ...
    public function filterByCreatedAt($createdAt = null, $comparison = null)
    {
        if (is_array($createdAt)) {
            ...
            if (isset($createdAt['min'])) {
                $this->addUsingAlias(RolesTableMap::COL_CREATED_AT, $createdAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($createdAt['max'])) {
                $this->addUsingAlias(RolesTableMap::COL_CREATED_AT, $createdAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(RolesTableMap::COL_CREATED_AT, $createdAt, $comparison);
    }
    ...
    public function filterByMenuRoles($menuRoles, $comparison = null)
    {
        if ($menuRoles instanceof \MenuRoles) {
            return $this
                ->addUsingAlias(RolesTableMap::COL_VALUE, $menuRoles->getRoleId(), $comparison);
    ...
    public function filterByUserLogin($userLogin, $comparison = null)
    {
        if ($userLogin instanceof \UserLogin) {
            return $this
                ->addUsingAlias(RolesTableMap::COL_VALUE, $userLogin->getRoleId(), $comparison);
    ...
    {
        if ($roles) {
            $this->addUsingAlias(RolesTableMap::COL_VALUE, $roles->getValue(), Criteria::NOT_EQUAL);
        }
