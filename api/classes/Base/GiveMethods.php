...
/**
 * Base class that represents a row from the 'give_methods' table.
 *
 * 
 *
 * @package    propel.generator..Base
 */
abstract class GiveMethods implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\GiveMethodsTableMap';
    ...
    /**
     * Initializes internal state of Base\GiveMethods object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>GiveMethods</code> instance.  If
     * <code>obj</code> is an instance of <code>GiveMethods</code>, delegates to
     * <code>equals(GiveMethods)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|GiveMethods The current object, for fluid interface
     */
     ...
     * @return $this|\GiveMethods The current object (for fluent API support)
     */
    public function setValue($v)
    {
        ...
        if ($this->value !== $v) {
            $this->value = $v;
            $this->modifiedColumns[GiveMethodsTableMap::COL_VALUE] = true;
        }
    ...
    public function setCode($v)
    {
        ...
        if ($this->code !== $v) {
            $this->code = $v;
            $this->modifiedColumns[GiveMethodsTableMap::COL_CODE] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[GiveMethodsTableMap::COL_NAME] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[GiveMethodsTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : GiveMethodsTableMap::translateFieldName('Value', TableMap::TYPE_PHPNAME, $indexType)];
            $this->value = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : GiveMethodsTableMap::translateFieldName('Code', TableMap::TYPE_PHPNAME, $indexType)];
            $this->code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : GiveMethodsTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : GiveMethodsTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = GiveMethodsTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\GiveMethods'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildGiveMethodsQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see GiveMethods::setDeleted()
     * @see GiveMethods::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildGiveMethodsQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                GiveMethodsTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[GiveMethodsTableMap::COL_VALUE] = true;
        if (null !== $this->value) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . GiveMethodsTableMap::COL_VALUE . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(GiveMethodsTableMap::COL_VALUE)) {
            $modifiedColumns[':p' . $index++]  = 'value';
        }
        if ($this->isColumnModified(GiveMethodsTableMap::COL_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'code';
        }
        if ($this->isColumnModified(GiveMethodsTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(GiveMethodsTableMap::COL_CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'created_at';
        }

        $sql = sprintf(
            'INSERT INTO give_methods (%s) VALUES (%s)',
    ...
    {
        $pos = GiveMethodsTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['GiveMethods'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['GiveMethods'][$this->hashCode()] = true;
        $keys = GiveMethodsTableMap::getFieldNames($keyType);
        $result = array(
    ...
    {
        $criteria = new Criteria(GiveMethodsTableMap::DATABASE_NAME);

        if ($this->isColumnModified(GiveMethodsTableMap::COL_VALUE)) {
            $criteria->add(GiveMethodsTableMap::COL_VALUE, $this->value);
        }
        if ($this->isColumnModified(GiveMethodsTableMap::COL_CODE)) {
            $criteria->add(GiveMethodsTableMap::COL_CODE, $this->code);
        }
        if ($this->isColumnModified(GiveMethodsTableMap::COL_NAME)) {
            $criteria->add(GiveMethodsTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(GiveMethodsTableMap::COL_CREATED_AT)) {
            $criteria->add(GiveMethodsTableMap::COL_CREATED_AT, $this->created_at);
        }
    ...
    {
        $criteria = ChildGiveMethodsQuery::create();
        $criteria->add(GiveMethodsTableMap::COL_VALUE, $this->value);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \GiveMethods (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \GiveMethods Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildGiveMethods is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildGiveMethods The current object (for fluent API support)
     */
    public function setGiveParishMethodss(Collection $giveParishMethodss, ConnectionInterface $con = null)
    {
        ...
        foreach ($giveParishMethodssToDelete as $giveParishMethodsRemoved) {
            $giveParishMethodsRemoved->setGiveMethods(null);
        }
    ...
    protected function doAddGiveParishMethods(ChildGiveParishMethods $giveParishMethods)
    {
        ...
        $giveParishMethods->setGiveMethods($this);
    }
    ...
    public function removeGiveParishMethods(ChildGiveParishMethods $giveParishMethods)
    {
        if ($this->getGiveParishMethodss()->contains($giveParishMethods)) {
            ...
            $giveParishMethods->setGiveMethods(null);
        }
     ...
     * Otherwise if this GiveMethods is new, it will return
     * an empty collection; or if this GiveMethods has previously
     * been saved, it will retrieve related GiveParishMethodss from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in GiveMethods.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildGiveParishMethods[] List of ChildGiveParishMethods objects
     */
    public function getGiveParishMethodssJoinParish(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildGiveParishMethodsQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(GiveMethodsTableMap::DEFAULT_STRING_FORMAT);
    }
