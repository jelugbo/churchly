...
abstract class Sessions implements ActiveRecordInterface 
{
    ...
    public function setAccess($v)
    {
        ...
        if ($this->access !== $v) {
            $this->access = $v;
            $this->modifiedColumns[SessionsTableMap::COL_ACCESS] = true;
        }
    ...
    public function setData($v)
    {
        ...
        if ($this->data !== $v) {
            $this->data = $v;
            $this->modifiedColumns[SessionsTableMap::COL_DATA] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SessionsTableMap::translateFieldName('Access', TableMap::TYPE_PHPNAME, $indexType)];
            $this->access = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : SessionsTableMap::translateFieldName('Data', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = SessionsTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(SessionsTableMap::COL_ACCESS)) {
            $modifiedColumns[':p' . $index++]  = 'access';
        }
        if ($this->isColumnModified(SessionsTableMap::COL_DATA)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SessionsTableMap::COL_ACCESS)) {
            $criteria->add(SessionsTableMap::COL_ACCESS, $this->access);
        }
        if ($this->isColumnModified(SessionsTableMap::COL_DATA)) {
            $criteria->add(SessionsTableMap::COL_DATA, $this->data);
        }
