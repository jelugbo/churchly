...
$arr_ids = GiveQuery::create()->findByParishId($_SESSION["parish_id"])->getColumnValues('ProfileId');
$obj_donor = UserProfileQuery::create()->filterByPrimaryKeys($arr_ids)->find();
...
<!--										<th>Envelope #</th>-->
									...
									<tbody>
									<?php foreach ($obj_donor as $do){
										$obj_profile = UserProfileQuery::create()->findOneByEmail($do->getEmail());
										?>
										<tr>
<!--											<td>--><?php //echo $do->getEnvelope() ?><!--</td>-->
											<td><?php echo $do->getEmail() ?></td>
											<td><?php echo is_null($obj_profile)?'Not Available':$obj_profile->getFname()?></td>
											<td><?php echo is_null($obj_profile)?'Not Available':$obj_profile->getLname() ?></td>
											<td><?php echo is_null($obj_profile)?'Not Available':$obj_profile->getPhone() ?></td>
										</tr>
									<?php }?>
									</tbody>
								</table>
