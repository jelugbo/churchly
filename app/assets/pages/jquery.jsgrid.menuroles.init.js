        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                var filtered_data = $.grep(response, function (client) {
                    console.log(client);
                    console.log(filter);
                    return  (!filter.MenuId || client.Parent === filter.MenuId)
...
!function($) {
    ...
    GridApp.prototype.createGrid = function ($element, options) {
        ...
        GridApp.prototype.init = function () {
            ...
            var options = {
                fields: [
                    {name: "RoleId", type: "select", items: JsDBSource.roles(), valueField: "Value", textField: "Name", title: "Role", width: 50},
                    {name: "MenuId", type: "select", items: JsDBSource.menus(), valueField: "Value", textField: "Name", title: "Menu Name", width: 50},
                    {name: "Access", type: "checkbox", width: 30, title: "Enable Access?",},
                    {type: "control"}
                ],
