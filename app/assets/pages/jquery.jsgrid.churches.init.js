            ...
            success: function(response) {
                ...
                var filtered_data = $.grep(response, function (client) {
                    return (!filter.Name || client.Name.indexOf(filter.Name) > -1)
                        && (!filter.ShortName || client.ShortName.indexOf(filter.ShortName) > -1)
        ...
        GridApp.prototype.init = function () {
            ...
            var options = {
                fields: [
                    ...
                    {name: "ShortName", type: "text", width: 50, title: "Short Name"},
                    {name: "Logo", type: "file", width: 50, align: "center"},
                    {type: "control"}
                ],
