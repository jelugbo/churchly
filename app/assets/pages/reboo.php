...
<div style="margin:0; padding:0; width:100% !important; font-family: 'Helvetica Neue', Helvetica, sans-serif; font-size:14px; line-height:145%; text-align:left;">
    <center>
        ...
        $order = get_post_meta( $ticket['order_id'] );
        error_log(print_r($order,true),3,'order_data.txt');
                    ...
                    <table class="inner-wrapper" border="0" cellpadding="0" cellspacing="0" width="620" bgcolor="#f7f7f7" style="margin:0 auto !important; width:620px; padding:0;">
                        <tr>
                            <td valign="top" class="ticket-content" align="left" width="580" border="0" cellpadding="20" cellspacing="0" style="padding:20px; background:#f7f7f7;">
                                ...
                                <h4 style="color:#0a0a0e!important"> Your Attendees:</h4>
                                <table class="ticket-details" border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
                                    <tr>
                                        <td class="ticket-details" valign="top" align="left" width="100" style="padding: 0; width:100px; margin:0 !important;">
                                            <h6 style="color:#909090 !important; margin:0 0 10px 0; font-family: 'Helvetica Neue', Helvetica, sans-serif; text-transform:uppercase; font-size:13px; font-weight:700 !important;"><?php esc_html_e( 'First Name', 'event-tickets' ); ?></h6>
													<span style="color:#0a0a0e !important; font-family: 'Helvetica Neue', Helvetica, sans-serif; font-size:15px;">
													<?php
                                                    for ($x = 1; $x <= 10; $x++) {
                                                    $var = $x.' Attendee First Name';
                                                    error_log(print_r($order[$var],true),3,'order_log.txt');
                                                    if (isset($order[$var])) {echo $order[$var][0].'<br>';}
                                        ...
                                        <td class="ticket-details" valign="top" align="left" width="120" style="padding: 0; width:120px; margin:0 !important;">
                                            <h6 style="color:#909090 !important; margin:0 0 10px 0; font-family: 'Helvetica Neue', Helvetica, sans-serif; text-transform:uppercase; font-size:13px; font-weight:700 !important;"><?php esc_html_e( 'Last Name', 'event-tickets' ); ?></h6>
													<span style="color:#0a0a0e !important; font-family: 'Helvetica Neue', Helvetica, sans-serif; font-size:15px;">
													<?php
                                                    for ($x = 1; $x <= 10; $x++) {
                                                    $var = $x.' Attendee Last Name';
                                                    error_log(print_r($order[$var],true),3,'order_log.txt');
                                                    if (isset($order[$var])) {echo $order[$var][0].'<br>';}
                                        ...
                                        <td class="ticket-details" valign="top" align="left" width="120" style="padding: 0 !important; width:120px; margin:0 !important;">
                                            <h6 style="color:#909090 !important; margin:0 0 10px 0; font-family: 'Helvetica Neue', Helvetica, sans-serif; text-transform:uppercase; font-size:13px; font-weight:700 !important;"><?php esc_html_e( 'Email Address', 'event-tickets' ); ?></h6>
													<span style="color:#0a0a0e !important; font-family: 'Helvetica Neue', Helvetica, sans-serif; font-size:15px;">
													<?php
                                                    for ($x = 1; $x <= 10; $x++) {
                                                    $var = $x.' Attendee Email';
                                                    error_log(print_r($order[$var],true),3,'order_log.txt');
                                                    if (isset($order[$var])) {echo $order[$var][0].'<br>';}
                                        ...
                                        <td class="ticket-details new-row new-left-row" valign="top" align="left" width="120" style="padding: 0; width:120px; margin:0 !important;">
                                            <h6 style="color:#909090 !important; margin:0 0 10px 0; font-family: 'Helvetica Neue', Helvetica, sans-serif; text-transform:uppercase; font-size:13px; font-weight:700 !important;"><?php esc_html_e( 'Phone Number', 'event-tickets' ); ?></h6>
													<span style="color:#0a0a0e !important; font-family: 'Helvetica Neue', Helvetica, sans-serif; font-size:15px;">
													<?php
                                                    for ($x = 1; $x <= 10; $x++) {
                                                    $var = $x.' Attendee Phone';
                                                    //error_log(print_r($order[$var],true),3,'order_log.txt');
                                                    if (isset($order[$var])) {echo $order[$var][0].'<br>';}
                                    ...
                                    <tr>
                                        <td valign="top" align="left" width="100%" height="30" style="height:30px; background:#f7f7f7; padding: 0 !important; margin:0 !important;">
                                            <div style="margin:0; height:30px;">
                                                <?php error_log(print_r($order['Seat Me With'],true),3,'order_log.txt'); if (isset($order['Seat Me With'])) {echo '<br>Seat me With: '.$order['Seat Me With'][0].'<br>';} ?>
                                            </div>
                                        </td>
                                    </tr>
                                </table>
        ...
        <h4 style="color:#0a0a0e!important">WE WILL HAVE A CHECK IN LIST AT OUR EVENT.  YOUR NAME AND YOUR GUESTS NAMES WILL BE ON OUR LIST</h4>
        <h4 style="color:#0a0a0e!important">WE WILL NOT BE COLLECTING YOUR DINNER TICKETS AT THE DOOR.  WE WILL BE USING OUR CHECK IN LIST</h4>
        <h4 style="color:#0a0a0e!important">See you on July 24th, 2017 at 9 a.m. registration and practice</h4>
        <h4 style="color:#0a0a0e!important">Thank you!</h4>
        <?php
        }//end foreach
