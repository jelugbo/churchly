            ...
            success: function(response) {
                ...
                var filtered_data = $.grep(response, function (client) {
                    return (!filter.Name || client.Name.indexOf(filter.Name) > -1)
                        && (!filter.ContactPerson || client.ContactPerson.indexOf(filter.ContactPerson) > -1)
...
!function($) {
    ...
    GridApp.prototype.createGrid = function ($element, options) {
        ...
        GridApp.prototype.init = function () {
            ...
            var options = {
                fields: [
                    {name: "Name", type: "text", width: 100, title: "Ministry", validate: "required"},
                    {name: "ContactPerson", type: "text", width: 100, title: "Contact Person", validate: "required"},
                    {name: "Email", type: "text", width: 75, validate: "required"},
                    {name: "Phone", type: "text", width: 75},
                    {type: "control"}
                ],
