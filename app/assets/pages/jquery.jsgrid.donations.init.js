            ...
            success: function(response) {
                ...
                var filtered_data = $.grep(response, function (client) {
                    return (!filter.Name || client.Name.indexOf(filter.Name) > -1)
                        && (!filter.ShortName || client.ShortName === filter.ShortName)
...
!function($) {
    ...
    GridApp.prototype.createGrid = function ($element, options) {
        ...
        GridApp.prototype.init = function () {
            ...
            var options = {
                fields: [
                    {name: "Fname", type: "text", width: 150},
                    {name: "Lname", type: "text", width: 50},
                    {name: "Logo", type: "text", width: 100},
                    {type: "control"}
                ],
