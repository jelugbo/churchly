...
if (isset($_POST['post_data'])) {
	$db = new Facebook();
	if (!empty($_POST['FacebookId'])) $db = FacebookQuery::create()->findPk($_POST['FacebookId']);
	$db->setParishId($_SESSION['parish_id']);
//	$db->setApiKey($_POST['ApiKey']);
//	$db->setSecretKey($_POST['SecretKey']);
	$db->setPageId($_POST['PageId']);
	$res = $db->save();
...
$obj_facebook = $obj_parish->getFacebooks()->getFirst();
?>
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-sm-12">
							...
							<h4 class="page-title">Facebook Setup</h4>
							<ol class="breadcrumb">
								<li><a href="index.php">Home</a></li>
								<li class="active">Facebook Setup</li>
							</ol>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="card-box">
								<h4 class="m-t-0 header-title">Facebook Setup</h4>
												...
												<div class="form-group">
													...
													<div class="col-md-10">
														<input type="text" name="PageId" required
														       value="<?php echo is_null($obj_facebook) ? ' ' : $obj_facebook->getPageId() ?>"
														       class="form-control">

													</div>
												</div>
												<?php if (is_null($obj_facebook)) { ?>
													<input type="text" name="new" class="hidden">
												<?php } ?>
												<input type="text"
												       value="<?php echo is_null($obj_facebook) ? '' : $obj_facebook->getValue() ?>"
												       name="FacebookId" class="hidden">
												<input type="text"
												       value="<?php echo is_null($obj_parish->getValue()) ? ' ' : $obj_parish->getValue() ?>"
												       name="ParishId" class="hidden">
