...
$obj_donations = GiveQuery::create()->findByParishId($_SESSION["parish_id"]);
						...
						<div class="col-xs-12">
							<div class="card-box">
								...
								<table id="datatable-buttons" class="table table-striped table-bordered">
									...
									<tbody>
									<?php foreach ($obj_donations as $do){
										$obj_profile = UserProfileQuery::create()->findPk($do->getProfileId());
										?>
										<tr>
<!--											<td>--><?php //echo is_null($obj_profile)?'Not Available': $do->getUserLogin()->getEnvelope()  ?><!--</td>-->
											<td><?php echo $obj_profile->getLname(). ' '.$obj_profile->getFname()?></td>
											<td><?php echo $do->getCreatedAt('m-d-Y')?></td>
											<td><?php echo $obj_profile->getEmail() ?></td>
											<td><?php echo $do->getDescription()?></td>
											<td><?php echo $do->getGiveParishMethods()->getGiveMethods()->getName() ?></td>
											<td><?php echo $do->getCurrency() ?></td>
											<td><?php echo $do->getTxnRef() ?></td>
											<td><?php echo $do->getTxnStatus() ?></td>
											<td><?php echo $do->getTotal() ?></td>
										</tr>
									<?php }?>
									</tbody>
								</table>
