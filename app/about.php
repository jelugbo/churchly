...
if (isset($_POST['post_data'])) {
    $db = new About();
    if (!empty($_POST['AboutId'])) $db = AboutQuery::create()->findPk($_POST['AboutId']);
    $db->setParishId($_SESSION["parish_id"]);
    $db->setAbout($_POST['About']);
    $res = $db->save();
                                ...
                                <h4 class="m-t-0 header-title">About Us</h4>
                                        ...
                                        <form class="form-horizontal" action="#" data-parsley-validate novalidate method="post">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text"
                                                           value="<?php echo is_null($obj_parish) ? ' ' : $obj_parish->getName() ?>"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                        <textarea name="About" required
                                                                  class="form-control"><?php echo is_null($obj_about) ? ' ' : $obj_about->getAbout() ?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <?php } ?>
                                            <input type="text"
                                                   value="<?php echo is_null($obj_about) ? '' : $obj_about->getValue() ?>"
                                                   name="AboutId" class="hidden">
